...
const CountryDropdownComponent = (
    ...
    const triggerClasses = cn(
        ...
        slim === true && "w-20 border-none px-0 shadow-none focus:ring-transparent"
    );
            ...
            <PopoverTrigger ref={ref} className={triggerClasses} disabled={disabled} {...props}>
                {selectedCountry ? (
                    <div className="flex flex-grow items-center gap-3 overflow-hidden">
                        <div className="inline-flex h-5 w-5 shrink-0 items-center justify-center gap-3 overflow-hidden rounded-full">
                        ...
                        {countryCode && <span className="overflow-hidden text-ellipsis whitespace-nowrap">{selectedCountry.countryCallingCodes[0]}</span>}
                    </div>
                ) : (
